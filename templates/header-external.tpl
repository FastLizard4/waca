...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <link href="{$baseurl}/components/bootstrap/css/bootstrap.css" rel="stylesheet">
    <style type="text/css">
      body {
        padding-top: 20px;
        padding-bottom: 40px;
    ...
    <link href="{$baseurl}/components/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
